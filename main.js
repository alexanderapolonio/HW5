...
function submitInfo() {
  ...
  let rResult = `${fname} ${lname} from age group ${ages.value} owns an ${models.value} ${versions.value} with size of ${sizes.value}. Here's the e-mail address for ${fname} ${lname}: ${email}`
